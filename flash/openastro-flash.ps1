...
function Get-EmmcDisk {
    ...
    Write-Host '  2. Open the case and short the two nRPIBOOT pads next to the'
    Write-Host '     SD-card slot with a jumper wire (keep them shorted). Photo:'
    Write-Host '     https://www.openastro.net/img/sbc/de035a79-7781-48b7-9d2b-e7f67dc5d166.webp'
