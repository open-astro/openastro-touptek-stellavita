#!/bin/bash
# Build the OpenAstro ToupTek StellaVita image (Raspberry Pi CM4 based).
#
...
# OpenAstro layer writes the StellaVita's power/USB GPIO line into
...
OUT="${2:-$REPODIR/images/openastro-touptek-stellavita.img.xz}"
ROOT_PART=2
BOOT_PART=1
